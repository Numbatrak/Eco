...
import type { ProductsSection as ProductsSectionData } from "../../types/siteConfig";
import type { PublicSiteProduct } from "../../types/publicSite";
          ...
          {products.map((product) => {
            ...
            return (
              <div key={product.id} className="st-card">
                <Link to={`/products/${product.id}`} className="st-card-link">
                  {product.imageUrl ? (
