...
import { GeneralExpenseTableHeader } from "./GeneralExpenseTableHeader";
import { GeneralExpenseTableRow } from "./GeneralExpenseTableRow";
...
interface GeneralExpenseTableProps {
  expenses: GeneralExpenseWithRelations[];
  loading: boolean;
  error: string | null;
...
export function GeneralExpenseTable({
  expenses,
  loading,
  error,
  onEdit,
    ...
    <div className="expense-table-container">
      <div className="expense-table-header">
        <div className="expense-table-header-content">
          <div className="expense-table-title-section">
            ...
            <div>
              <h2 className="expense-table-title">General Expenses</h2>
      ...
      <div className="expense-table-wrapper">
        <table className="expense-table">
          <GeneralExpenseTableHeader />
          <tbody>
            {loading ? (
              <tr>
                <TableLoadingCell colSpan={9} message="Loading expenses…" />
              </tr>
            ) : error ? (
              <tr>
                <td colSpan={9} className="expense-table-error">
                  {error}
                </td>
              </tr>
            ) : expenses.length === 0 ? (
