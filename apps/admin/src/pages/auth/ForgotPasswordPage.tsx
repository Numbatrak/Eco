...
export default function ForgotPasswordPage(): React.ReactElement {
  ...
  async function onSubmit(values: PasswordResetRequest): Promise<void> {
    ...
    try {
      ...
      // A network/transport failure is the only thing that should stop us from
      // showing the generic message - the backend response itself never
      // distinguishes a real account from an unknown one here.
